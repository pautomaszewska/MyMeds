...
from medications.views import MedicineList, AddMedicine, DeleteMedicine, UpdateMedicine, ExpiredMedicine, RegisterView
...
urlpatterns = [
    ...
    path('expired/', ExpiredMedicine.as_view(), name='expired'),
